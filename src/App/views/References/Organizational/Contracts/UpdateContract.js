...
const UpdateContract = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setCurrencyRate(formDt.data.CurrencySum);
  ...
  const onMainFormFinish = (values) => {
    ...
    paymentScheduleTableData.forEach(item => paymentScheduleTableSum += item.Sum);
    let contractSpecTableSum = 0;
    contractSpecTableData.forEach(item => contractSpecTableSum += item.Sum);
              ...
              >
                <Row gutter={[15, 0]}>
                  ...
                  <Col xl={4} lg={12}>
                    ...
                    >
                      <Input style={{ width: "100%" }} placeholder={t("code")} />
                    </Form.Item>
                  </Col>
                  <Col xl={4} lg={12}>
                    <Form.Item
                    ...
                    >
                      <Input
                        ...
                        addonAfter={<Button
                          ...
                          onClick={() => {
                            setContractPayerModalVisible(true);
                          }}
                        />}
                      />
                    </Form.Item>
